...
if (isset($_SESSION["idAdmin"])) {
    ...
    if (mysqli_num_rows($resultUser) > 0) {
        while ($rowUser = mysqli_fetch_assoc($resultUser)) {
            if ($rowUser['status_user'] == 1) { } else {
                $showUser = $showUser . '<tr>
                        <td>' . $rowUser["id"] . '</td>
                        <td>' . $rowUser["username"] . '</td>
                        <td>' . $rowUser["email"] . '</td>
                        <td>' . $rowUser["status_user"] . '</td>
                        <td>' . $rowUser["point_user"] . '</td>
                        <td>
                            <a href="deleteUser.php?id=' . $rowUser["id"] . '" class="btn btn-outline-danger">
                                Ban
                            </a>
                        </td>
                        </tr>
