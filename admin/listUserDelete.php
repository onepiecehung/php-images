...
if (isset($_SESSION["idAdmin"])) {
    $resultUserDeleted = $link->query("SELECT * from deleteuser");
    if (mysqli_num_rows($resultUserDeleted) > 0) {
        while ($rowUserDeleted = mysqli_fetch_assoc($resultUserDeleted)) {
            $showUserDeleted = $showUserDeleted . '<tr>
                <td>' . $rowUserDeleted["id"] . '</td>
                <td>' . $rowUserDeleted["email"] . '</td>
                <td>' . $rowUserDeleted["deltime"] . '</td>
                <td>
                    <a href="unban.php?id=' . $rowUserDeleted["id"] . '" class="btn btn-outline-primary">
                        Unban
                    </a>
                </td>
                <td>
                    <a href="/admin/listdeleteuser/<%=data.posts[i].id %>" class="btn btn-outline-danger">
                        Permanent Ban
                    </a>
                </td>
            </tr>';
...
<head>
    ...
    <title>3RAW - List Users Deleted</title>
